...
/* 
Знания - сила!
https://javarush.ru/groups/posts/590-klass-messageformat?post=full#discussion
https://www.youtube.com/watch?t=2646&v=Dm6ybcQmGpw&feature=youtu.be
*/
    ...
    public static void sort(List<Stock> list) {
        ...
        Collections.sort(list, new Comparator<Stock>() {
            ...
            public int compare (Stock stock1, Stock stock2) {
                ...
                int nameComparator = name1.compareTo(name2);
                ...
                if (nameComparator != 0) {
                    ...
                    int dateComparator = date2.compareTo(date1);
                    ...
                    if (dateComparator != 0) {
                        ...
                        int changeComparator = change2.compareTo(change1);
                        if (changeComparator != 0) {
                            return changeComparator;
                        }
                        else {
                            return 0;
                        }
