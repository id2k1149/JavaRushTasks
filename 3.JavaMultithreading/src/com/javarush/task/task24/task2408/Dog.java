    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable {
            ...
            private String getName(){
                String quotes = super.getSuperQuotes();
...
//                    char letter = today.charAt(size-2);
//                    letter = Character.toUpperCase(letter);
//                    String up = Character.toString(letter);
//                    String today_1 = today.substring(0,size-2);
//                    String today_2 =  up + today.substring(size-1, size);
//                    today = today_1 + today_2;
                    ...
                    return (getName() + " лает г" + a + "в! " + today);
                }
                // java
//                if (i < 1)
//                    return getName() + " спит.";
