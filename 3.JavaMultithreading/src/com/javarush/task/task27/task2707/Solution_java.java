...
public class Solution_java {
    ...
    public static boolean isLockOrderNormal(final Solution_java solution, final Object o1, final Object o2) throws Exception {
        //do something here
        synchronized (o1) {
    ...
    public static void main(String[] args) throws Exception {
        final Solution_java solution = new Solution_java();
