...
public class Room {
    ...
    public void print() {
        ...
        screen[x_head][y_head] = 2;

        for (SnakeSection each: game.snake.getSections()) {
            screen[each.getX()][each.getY()] = 1;
        }

        //Рисуем мышь
        int x_mouse = game.mouse.getX();
        int y_mouse = game.mouse.getY();
        screen[x_mouse][y_mouse] = 3;
    ...
    public void sleep() throws InterruptedException {
        ...
        else if (level <= 15) Thread.sleep(300);
