...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> frameListDown = new ArrayList<>();
        frameListDown.add(ShapeMatrix.FIRE_DOWN_1);
        frameListDown.add(ShapeMatrix.FIRE_DOWN_2);
        frameListDown.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(frameListDown);

        List<int[][]> frameListSide = new ArrayList<>();
        frameListSide.add(ShapeMatrix.FIRE_SIDE_1);
        frameListSide.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(frameListSide);
        rightFire = new RocketFire(frameListSide);
