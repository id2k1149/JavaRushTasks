...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.humanRelationships.length);
        System.out.println(solution.humanRelationships[2][0]);
        System.out.println(solution.humanRelationships[7].length);
//        for (int i = 0; i < humanRelationships.; i++) {
//
//        }
