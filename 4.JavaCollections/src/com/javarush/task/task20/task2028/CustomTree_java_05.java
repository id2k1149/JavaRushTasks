...
public class CustomTree_java_05 extends AbstractList<String> implements Cloneable, Serializable {
    /**
    ...
    public boolean equals(Object o) {
        ...
        CustomTree_java_05 customTree = (CustomTree_java_05) o;
    ...
    private class SolutionIterator implements Iterator<String> {
        ...
        public synchronized void remove() {
            ...
            CustomTree_java_05.this.remove(list.get(lastReturned).elementName);
            index = lastReturned;
            lastReturned = -1;
            list = queue;
        }
