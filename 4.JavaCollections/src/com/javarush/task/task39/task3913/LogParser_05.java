...
public class LogParser_05 implements IPQuery, UserQuery, DateQuery, EventQuery, QLQuery {
    private Path logDir;
    private List<Logs> logs = new ArrayList<>();
    private DateFormat simpleDateFormat = new SimpleDateFormat("d.M.yyyy H:m:s");

    public LogParser_05(Path logDir) {
        this.logDir = logDir;
        readLogs();
    }
    ...
    */
    ...
    public Set<Object> execute(String query) {
        ...
        if (queryElements.length == 2) {
            return getQuery(queryElements[1]);
        }

        return new HashSet<>();
    }

    public Set<Object> getQuery(String query) {
