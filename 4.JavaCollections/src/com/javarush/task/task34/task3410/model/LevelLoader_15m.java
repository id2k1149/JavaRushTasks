...
public class LevelLoader_15m {

    public LevelLoader_15m(Path levels) {
    }
    ...
    public GameObjects getLevel(int level) {
        ...
        boxes.add(new Box(x + 5 * Model.FIELD_CELL_SIZE, y + 5 * Model.FIELD_CELL_SIZE));
        boxes.add(new Box(x + 6 * Model.FIELD_CELL_SIZE, y + 6 * Model.FIELD_CELL_SIZE));

        homes.add(new Home(x + 1 * Model.FIELD_CELL_SIZE, y + Model.FIELD_CELL_SIZE));
        homes.add(new Home(x + 2 * Model.FIELD_CELL_SIZE, y + 2 * Model.FIELD_CELL_SIZE));
